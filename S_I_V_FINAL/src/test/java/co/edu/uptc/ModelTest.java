...
class ModelTest {
    ...
    @Test
    void removePersonReturnsFifoFirst() {
        model.addPerson("Ana", "Lopez", Gender.FEMININE, LocalDate.of(1995, 3, 10));
        model.addPerson("Luis", "Garcia", Gender.MASCULINE, LocalDate.of(1998, 7, 22));
        assertEquals("Ana", model.removePerson().getFirstName());
    }
    ...
    @Test
    void removePersonFromEmptyQueueThrowsException() {
        assertThrows(IllegalStateException.class, () -> model.removePerson());
    }

    @Test
    void removeProductFromEmptyListThrowsException() {
        assertThrows(IllegalStateException.class, () -> model.removeProduct());
    }

    @Test
    void addPersonWithInvalidNameThrowsException() {
        assertThrows(IllegalArgumentException.class,
                () -> model.addPerson("A", "Perez", Gender.MASCULINE, LocalDate.of(2000, 1, 1)));
    }
}
